...
public class AcessoFireBird implements AcessoBDBehavior {
     ...
     * 
     */
    public AcessoFireBird(String servidorBD, String nomeBD, String usuarioBD, String senhaBD) {
        this();
    ...
    public void setStringConexao(String servidorBD, String nomeBD, String usuarioBD, String senhaBD) {
        ...
        stringDeConexao = "jdbc:firebirdsql://";
    ...
    /**
     * 
     * Método de retorno das informações referentes às tabelas do banco de dados. <br />
     * @version 1.0
     * @throws SQLException
     * 
     */
    ...
    public void getTabelsColumns(String tableName) {
        try {
            ...
            System.out.println("[ERRO] Erro ao ler informações do Banco de Dados(Colunas): " +ex);
        } finally {
            //desconectar();
        }
    }
