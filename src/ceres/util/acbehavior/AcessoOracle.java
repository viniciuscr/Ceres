...
public class AcessoOracle implements AcessoBDBehavior {
     ...
     * 
     */
    public AcessoOracle(String servidorBD, String nomeBD, String usuarioBD, String senhaBD) {
        this();
    ...
    public void setStringConexao(String servidorBD, String nomeBD, String usuarioBD, String senhaBD) {
        ...
        stringDeConexao = "jdbc:oracle:thin://";
